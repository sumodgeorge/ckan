...
def resource_dict_to_api(res_dict: Dict[str, Any], package_id: str, context: Context) -> None:
    res_dict.pop("state")
...
def activity_dictize(activity: model.Activity, context: Context, include_data: bool=False) -> Dict[str, Any]:
